...
BOT_TOKEN = "7541308074:AAEw-zoUAlecXaDdHiSZ_AZh41x05UJR-f8"
PAYMENT_CHANNEL = "@payment143ara" #add payment channel here including the '@' sign
OWNER_ID = 7323294317 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@kauya_on_fire"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
